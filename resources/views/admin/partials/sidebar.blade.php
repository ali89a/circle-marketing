<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class="{{ Request::segment(2) == 'work-order' || Request::segment(2) == 'service' ? 'has-sub sidebar-group-active open' : '' }} nav-item">
        ...
        <ul class="menu-content">
            ...
            <li class="{{ Request::segment(2) == 'workorder' && Request::segment(3) == 'cancle-list' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('cancleList') }}"><i data-feather="circle">
                    </i><span class="menu-item text-truncate" data-i18n="Layout Boxed">Cancle Work Order List</span></a>
            </li>
            ...
            <li class="{{ Request::segment(2) == 'monthly-invoice' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('monthly.invoice') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">Monthly Invoice</span></a>
            </li>
...
<li class="{{ Request::segment(2) == 'marketing-work-limit' ? 'has-sub sidebar-group-active open' : '' }} nav-item">
    <a class="d-flex align-items-center" href="#"><i data-feather="layout">
        </i><span class="menu-title text-truncate" data-i18n="Page Layouts">Marketing Work Limit</span></a>
    <ul class="menu-content">
        <li class="{{ Request::segment(2) == 'marketing-work-limit' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('marketingWorkLimit') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">Marketing Work Limit</span></a>
        </li>
    </ul>
</li>

<li class="{{ Request::segment(2) == 'report' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout">
    ...
    <ul class="menu-content">
        ...
        <li class="{{ Request::segment(2) == 'marketing-report-analysis' && Request::segment(3) == '' ? 'active' : '' }}">
            <a class="d-flex align-items-center" href="{{ route('marketingReportAnalysis') }}"><i data-feather="circle">
...
<li class="{{ Request::segment(2) == 'customer-relation' ? 'has-sub sidebar-group-active open' : '' }} nav-item">
    <a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">CRM</span><span class="badge badge-light-danger badge-pill ml-auto mr-1"></span></a>
    <ul class="menu-content">
        ...
        <li class="{{ Request::segment(2) == '' && Request::segment(3) == 'view' ? 'active' : '' }}">
            <a class="d-flex align-items-center" href="{{ route('customer-relation.index') }}"><i data-feather="circle">
        ...
        <li class="{{ Request::segment(2) == 'crm-work-limit' && Request::segment(3) == '' ? 'active' : '' }}">
            <a class="d-flex align-items-center" href="{{ route('customerWorkLimit') }}"><i data-feather="circle">
        ...
        <li class="{{ Request::segment(2) == 'crm-work-analysis' && Request::segment(3) == '' ? 'active' : '' }}">
            <a class="d-flex align-items-center" href="{{ route('customerWorkAnalysis') }}"><i data-feather="circle">
...
<li class="{{ Request::segment(2) == 'role' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Access Control</span><span class="badge badge-light-danger badge-pill ml-auto mr-1">3</span></a>
    <ul class="menu-content">
...
<li class="{{ Request::segment(2) == 'env-dynamic' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Settings</span></a>
    <ul class="menu-content">
        <li class="{{ Request::segment(2) == 'env-dynamic' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('env-dynamic.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">Env
                    Dynamic</span></a>
        </li>

    </ul>
</li>
<li class="{{ Request::segment(2) == 'district' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Location</span></a>
    <ul class="menu-content">
        <li class="{{ Request::segment(2) == 'division' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('division.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">Division</span></a>
        </li>
        <li class="{{ Request::segment(2) == 'district' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('district.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">District</span></a>
        </li>
        <li class="{{ Request::segment(2) == 'upazila' ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('upazila.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Collapsed Menu">Upazila</span></a>
        </li>
