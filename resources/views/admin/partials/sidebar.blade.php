...
<li class="{{ Request::segment(2) == 'marketing-work-limit' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a
    class="d-flex align-items-center" href="#"><i data-feather="layout">
    </i><span class="menu-title text-truncate" data-i18n="Page Layouts">Marketing Work Limit</span></a>
  <ul class="menu-content">
    <li class="{{ (Request::segment(2) == 'marketing-work-limit' )?'active':''}}"><a class="d-flex align-items-center"
    href="{{ route('marketingWorkLimit') }}"><i data-feather="circle"></i><span class="menu-item text-truncate"
  ...
  <ul class="menu-content">
    ...
    <li class="{{ Request::segment(2) == 'marketing-report-analysis' && Request::segment(3) == '' ? 'active' : '' }}">
      <a class="d-flex align-items-center" href="{{ route('marketingReportAnalysis') }}"><i data-feather="circle">
        </i><span class="menu-item text-truncate" data-i18n="Layout Boxed">Marketing Report Analysis</span></a>
    </li>
  </ul>
</li>
...
<li class="{{ Request::segment(2) == 'role' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a
    class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate"
      data-i18n="Page Layouts">Access Control</span><span
      class="badge badge-light-danger badge-pill ml-auto mr-1">3</span></a>
  <ul class="menu-content">
    <li><a class="d-flex align-items-center" href="{{ route('permission.index') }}"><i data-feather="circle"></i><span
    ...
    <li class="{{ Request::segment(2) == 'role' ? 'active' : '' }}"><a class="d-flex align-items-center"
        href="{{ route('role.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate"
          data-i18n="Layout Boxed">Role</span></a>
    </li>
    <li class="{{ Request::segment(2) == 'admin' ? 'active' : '' }}"><a class="d-flex align-items-center"
        href="{{ route('admin.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate"
          data-i18n="Without Menu">Admin</span></a>
    </li>
  </ul>
</li>
<li class="{{ Request::segment(2) == 'env-dynamic' ? 'has-sub sidebar-group-active open' : '' }} nav-item"><a
    class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate"
      data-i18n="Page Layouts">Settings</span></a>
  <ul class="menu-content">
    <li class="{{ Request::segment(2) == 'env-dynamic' ? 'active' : '' }}"><a class="d-flex align-items-center"
