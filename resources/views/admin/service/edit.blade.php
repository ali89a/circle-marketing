            ...
            <div class="form-group breadcrumb-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('service.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square mr-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="type" class="form-control" value="separate" {{ $model->type == 'separate' ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
