                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-responsive table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Downgradation Delivery Date:</td>
                                                        <td>
                                                        <input type="text" name="downgrade_delivery_date" id="downgrade_delivery_date" class="form-control flatpickr-basic flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly" required="required">
