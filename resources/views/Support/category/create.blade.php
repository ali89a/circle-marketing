                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('support-category.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square mr-1">
                            ...
                            </svg><span class="align-middle">Category List</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ticket Category Create</h4>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('support-category.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
