...
<div class="card" style="background:#e8f8ff">
  <!---->
  <!---->
      ...
      <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
          <span class="b-avatar mr-75 badge-secondary rounded-circle"
              ...
              <span class="b-avatar-img">
                  @if($comment->customer->img_url)                                       

                      <img src="{{asset('storage/customer/'.$comment->customer->img_url)}}" alt=" No File" class="img-fluid">
                  @endif
              </span>
              <!----></span>
          <div class="mail-items">
              <h5 class="mb-0"> {{$comment->customer->name }} </h5>
              <div class="dropdown b-dropdown email-info-dropup btn-group" id="__BVID__1120">
                  <!----><button aria-haspopup="true" aria-expanded="false" type="button"
                      ...
                      id="__BVID__1120__BV_toggle_"><span
                          class="font-small-3 text-muted mr-25">{{$comment->customer->email}}</span></button>                                            
              </div>
          </div>
      </div>
